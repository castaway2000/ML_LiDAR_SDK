...
#pragma pack(pop)
	...
	private:
		...
		//Processing Trigger
		bool zigzagfilling = true;
		bool deflaring = true;
		int tr_retro_threshold_ml0 = 110;
		int tr_retro_threshold_ml2 = 700;
	};
